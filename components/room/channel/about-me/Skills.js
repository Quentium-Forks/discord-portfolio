...
export default function Skills ({ name }) {
    return (
        <div>
            ...
            <ChannelMessage author="Anthony Adam" date="Hier à 08:39">
                <h3 className="bold">Dans le web :</h3>
                <div className="skills">
                    <ul>
                        <li><img src="/img/emoji/pushpin.svg" className="emoji-s" alt=""/><span className="underline"> Les classiques</span> : <img
                            src="/img/emoji/html.png" alt="icon HTML5" className="emoji-s"/> / <img src="/img/emoji/css.png" alt="icon CSS3" className="emoji-s"/> / <img
                            src="/img/emoji/js.png" alt="icon JavaScript" className="emoji-s"/> / <img src="/img/emoji/php.png" alt="icon PHP" className="emoji-s"/></li>
                        ...
                        <li><img src="/img/emoji/pushpin.svg" className="emoji-s" alt=""/><span className="underline"> Les framework</span> : <img
                            src="/img/emoji/symfony.png" alt="icon Symfony" className="emoji-s"/> / <img
                    ...
                    <ul>
                        ...
                        <li><img src="/img/emoji/pushpin.svg" className="emoji-s" alt=""/><span className="underline"> Les CMS</span> : <img src="/img/emoji/wordpress.png" alt="icon Wordpress" className="emoji-s"/> / strapi</li>
                    </ul>
                </div>
            </ChannelMessage>
            <ChannelMessage author="Anthony Adam" date="Hier à 08:39">
                ...
                <div className="skills">
                    <ul>
                        ...
                        <li><img src="/img/emoji/pushpin.svg" className="emoji-s" alt=""/><span className="underline"> les moteurs de jeu</span> :  Unity / Unreal </li>
                    </ul>
                    <ul>
                        <li><img src="/img/emoji/pushpin.svg" className="emoji-s" alt=""/><span className="underline"> La 3D</span> : Maya / C4D</li>
                        <li><img src="/img/emoji/pushpin.svg" className="emoji-s" alt=""/><span className="underline"> Bureautique</span> : Suite office / suite Adobe</li>
                    </ul>
                </div>
            </ChannelMessage>
